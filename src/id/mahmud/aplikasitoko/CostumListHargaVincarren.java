...
public class CostumListHargaVincarren extends ArrayAdapter<String> {
	...
	//deklarasi
		...
		private final Integer[] imageId;
	        ...
	        public CostumListHargaVincarren(Activity context,String[] web,String[]ket, Integer[] imageId){
			super(context,R.layout.activity_costum_list_harga_vincarren, web);
	        ...
	        public View getView(int position, View view, ViewGroup parent){
				...
				View rowView = inflater.inflate(R.layout.activity_costum_list_harga_vincarren,null);
